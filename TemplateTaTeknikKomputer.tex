...
\JudulTAInd{SISTEM ESTIMASI KECEPATAN KENDARAAN MENGGUNAKAN \emph{YOLOv8} BERBASIS VIDEO \emph{DRONE} PADA \emph{JETSON NANO}}
\JudulTAEng{VEHICLE SPEED ESTIMATION SYSTEM USING YOLOv8 BASED ON DRONE VIDEO ON JETSON NANO}
\Tempat{Surabaya}
